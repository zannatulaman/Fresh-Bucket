      ...
      <div className="product2-wrapper mt-30 container">
        <div className="flex align-center justify-between flex-wrap">
          ...
          <div className="buttons">
            <button className= {isActiveButton === 'all'? "secondary-btn": "non-active-btn"} onClick={()=> {
                    handleClick('all');
                    handleFilter('');
            }}>All</button>
            <button className= {isActiveButton === 'vegetable'? "secondary-btn": "non-active-btn"}  onClick={()=> {
                    handleClick('vegetable');
                    handleFilter('vegetable');
            }}>Vegetable</button>
            <button className={isActiveButton === 'fruit'? "secondary-btn": "non-active-btn"} onClick={()=> {
                    handleClick('fruit');
                    handleFilter('fruit');
            }}>Fruit</button>
            <button className= {isActiveButton === 'bread'? "secondary-btn": "non-active-btn"} onClick={()=> handleClick('bread')}>Bread</button>
          </div>
        </div>
          ...
          <div className="main-grid mt-30">
            ...
            <div className="midbannerInfo">
             <img className="banner-image" src="/images/product2/midBannerInfo.png" alt="Banner-info" />
            <div className="midbanner-details">
            <h6 className="special-offer">Special Offer</h6>
             <h1 className="discount">50% off</h1>
             <button className="shop-now secondary-btn">Shop now &rarr;</button>
            </div>
            </div>
          </div>        
